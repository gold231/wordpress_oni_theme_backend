			...
			<?php if(!empty($client_name)) {
				...
				<div class="grid__item  one-half  lap-and-up-one-quarter  push-half--bottom">
					<div class="entry__meta-box">
						<span class="meta-box__title"><?php esc_attr_e('Client', 'oni'); ?></span>
				...
				if(!empty($event_date)) {
					...
					<div class="grid__item  one-half  lap-and-up-one-quarter  push-half--bottom">
						<div class="entry__meta-box">
							<span class="meta-box__title"><?php esc_html_e('Event date', 'oni'); ?></span>
				...
				if(!empty($number_of_images)) {
					...
					<div class="grid__item  one-half  lap-and-up-one-quarter  push-half--bottom">
						<div class="entry__meta-box">
							<span class="meta-box__title"><?php esc_html_e('Images', 'oni'); ?></span>
				...
				if(!empty($file)) {
					...
					<div class="grid__item  one-half  lap-and-up-one-quarter  push-half--bottom">
						<div class="entry__meta-box">
							<button class="button-download  js-download" onclick="window.open('<?php echo esc_url($file); ?>')"><?php esc_html_e('Download', 'oni'); ?>
							</button>
						</div>
					</div>
					<?php
