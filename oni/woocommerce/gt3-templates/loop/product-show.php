...
$catalog_orderby_options = array(
	$products_count => esc_html__( 'Default', 'oni' ),
...
<form class="woocommerce-ordering products-show" method="get">
	<p class="gt3-products-header-sort_by"><?php esc_html_e('Show:', 'oni'); ?></p>
	<div class="gt3-woocommerce-ordering-select">
		<select name="show" class="orderby" title="<?php esc_attr_e('orderby', 'oni'); ?>">
